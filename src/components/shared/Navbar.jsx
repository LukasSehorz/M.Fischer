      ...
      <div className="grid h-auto min-h-[4.5rem] grid-cols-[1fr_max-content_1fr] items-center px-[5%]">
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          <a
            ...
            aria-label="Anrufen"
            className="flex lg:hidden items-center justify-center w-10 h-10 text-[#28282B] hover:text-[#8B1A1A] transition-colors duration-200"
          >
          ...
          {/* Desktop: full button with number */}
          <a
            href="tel:+491754322110"
            className="hidden lg:inline-flex items-center gap-2 border border-[#28282B]/30 px-5 py-2 font-body text-sm font-medium tracking-wide text-[#28282B]/75 transition-colors duration-200 hover:border-[#8B1A1A] hover:text-[#8B1A1A]"
          >
