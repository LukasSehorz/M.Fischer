        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
          <div>
            ...
            <p className="mb-6 font-body text-base leading-relaxed text-text-secondary md:text-lg">
              Michael M. Fischer gründete das Unternehmen 1952 als Maurerfirma mit drei Mitarbeitern in Rott am Inn.
              Unter seinen Söhnen Dieter und Manfred M. Fischer wuchs es zu einem Bauunternehmen mit 30 Mitarbeitern heran.
              Heute liegt die Geschäftsführung in den Händen von <strong className="text-text-primary font-semibold">Claudia M. Fischer</strong> und <strong className="text-text-primary font-semibold">M. Fischer</strong> – bereits die dritte Generation.
            </p>
          ...
          <div className="overflow-hidden">
            <img
              ...
              alt="M. Fischer Maschinenbetrieb – Facharbeiter auf der Baustelle"
            />
          </div>
        </div>
      </div>
