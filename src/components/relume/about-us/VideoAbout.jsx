      ...
      <div className="container max-w-3xl mx-auto">
        ...
        <div className="mb-8 md:mb-10">
          ...
          <h2
            ...
            style={{ fontSize: "clamp(2rem, 4vw, 3rem)", color: "#28282B" }}
          >
        ...
        {/* Text below */}
        <p ref={paraRef} className="mt-6 font-body text-base leading-relaxed text-[#28282B]/60 md:text-lg max-w-xl">
          Was Michael M. Fischer 1952 mit drei Mitarbeitern begann, tragen heute
