...
const projects = [
  {
    ...
    detail: "Für eine Privatfamilie in Rott am Inn haben wir den kompletten Hausanschluss und die Drainage neu verlegt. Saubere Grabenführung, fachgerechte Rohrlage auf Sandbett und sorgfältiger Abschluss – alles aus einer Hand.",
  },
  {
    id: "02",
    ...
    detail: "Wir haben ein altes Wirtschaftsgebäude vollständig zurückgebaut – inklusive Fundamenten, Sortierung des Abbruchmaterials und fachgerechter Entsorgung. Das Grundstück wurde anschließend planiert und für die Neubebauung vorbereitet.",
  },
  {
    id: "03",
    ...
    detail: "Für ein Mehrfamilienhaus in Bruckmühl haben wir vier Stellplätze neu angelegt – Erdaushub, Schotterkoffer, Vlies und Schotteroberfläche. Die Entwässerung wurde direkt mitgeplant und angeschlossen.",
  },
  {
    id: "04",
    ...
    detail: "Wir haben den Kanalgraben für einen Neubau ausgehoben, die Abwasserleitung verlegt und den Anschluss an den öffentlichen Kanal hergestellt. Enge Abstimmung mit dem Bauherrn und der Gemeinde sorgte für reibungslosen Ablauf.",
  },
  {
    id: "05",
    ...
    detail: "Auf einem Privatgrundstück in Rott am Inn haben wir mehrere große Bäume gefällt, die Stümpfe gerodet und das gesamte Holz abtransportiert. Das Grundstück war anschließend bereit für die weitere Gartengestaltung.",
  },
];
