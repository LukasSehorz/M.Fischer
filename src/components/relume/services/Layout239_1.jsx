    ...
    const ctx = gsap.context(() => {
      ...
      certCellsRef.current.forEach((cell, idx) => {
        ...
        cell.addEventListener("mouseenter", () => {
          ...
          gsap.to(label,  { y: -3, color: "#8B1A1A", duration: 0.4, ease: "power3.out" });
        });
  ...
  return (
    <section ref={sectionRef} className="bg-[#f0f0ef] py-16 md:py-24 lg:py-28 overflow-hidden">
      ...
      <div className="container px-[5%] mb-12 md:mb-16">
        ...
        <h2
          ref={headingRef}
          className="font-heading font-bold leading-tight tracking-tight text-[#28282B]"
      ...
      <div ref={certStripRef} className="mb-16" style={{ borderTop: "2px solid #8B1A1A" }}>
        <div
      ...
      <div className="container px-[5%] mb-6">
        <p ref={partnerLabelRef} className="font-body text-xs font-semibold uppercase tracking-[0.2em] text-[#28282B]/40">
          Partner & Lieferanten
        </p>
      </div>

      {/* Partner marquee — full width */}
      <div ref={marqueeWrapRef} className="overflow-hidden border-y border-[#28282B]/8">
          ...
          {track.map((p, i) => (
            ...
            >
              {p.logo ? (
                ...
                <span className="font-heading text-lg font-bold text-[#28282B]/30">
                  {p.label}
                </span>
              )}
            </div>
